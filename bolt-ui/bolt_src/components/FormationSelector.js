    ...
    <div class="details-section">
      ...
      <div class="tactical-advice">
        ...
        <div class="advice-content">
          <p class="advice-text">Questa formazione è equilibrata e si adatta bene a diversi stili di gioco. Assicurati di avere centrocampisti con buona resistenza per coprire entrambe le fasi.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  constructor(element, options = {}) {
    ...
    this.formations = {
      '4-4-2': {
        ...
        advice: 'Questa formazione è equilibrata e si adatta bene a diversi stili di gioco. Assicurati di avere centrocampisti con buona resistenza per coprire entrambe le fasi.'
      },
      '4-3-3': {
        name: '4-3-3',
      ...
      '4-2-3-1': {
        ...
        advice: 'Formazione versatile e moderna. Il trequartista centrale è fondamentale per collegare centrocampo e attacco. Buon equilibrio tra fase offensiva e difensiva.'
      },
      '5-3-2': {
        name: '5-3-2',
        ...
        advice: 'Formazione molto solida difensivamente. Ideale contro avversari più forti. I terzini devono supportare la fase offensiva quando possibile.'
      },
      '4-1-2-1-2': {
        name: '4-1-2-1-2',
        ...
        advice: 'Formazione a diamante che privilegia il gioco centrale. Richiede terzini con buona spinta offensiva per garantire ampiezza. Il mediano davanti alla difesa è fondamentale.'
      }
    };
